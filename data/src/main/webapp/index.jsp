...
<a class="navbar-brand" href="#"> <img
	...
	<form action="takeEdto" method="get">
		...
		<label>Family lives in: ${fdto.familyLives}</label><br>
		 <label>Total Family members: ${fdto.totalMembers}</label><br> 
		  <label>Sibling: ${fdto.sibling}</label><br> 
	...
	<form action="takeBeverage" method="get">
		...
		<input type="submit" value="get Beverage List" /> <br> 
		<label>1: ${bdto.juice1}</label><br> 
		<label>2 : ${bdto.juice2}</label><br>
		<label>3 : ${bdto.juice3}</label><br>
		 <label>4 :${bdto.juice4}</label><br> 
		 <label>5 : ${bdto.juice5}</label><br>
		  <label>6	: ${bdto.juice6}</label><br>
		   <label>7 : ${bdto.juice7}</label><br>
