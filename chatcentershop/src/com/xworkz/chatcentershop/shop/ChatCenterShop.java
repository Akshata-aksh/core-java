...
public class ChatCenterShop {
	...
	public ChatCenterShop(String name,String gstNo,String address,String staffName[],long staffContactNo[], String menu[], String billingMethod[]  ) {
